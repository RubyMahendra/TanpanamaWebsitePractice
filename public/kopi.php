    ...
    <section id="menu" class="menu-section">
        <div class="container">
            ...
            <?php
                ...
                $sql = "SELECT a.*, b.kategori FROM kopi a JOIN kategori b ON a.id_kategori=b.id WHERE a.id_kategori='" . $_GET['kat'] . "' ";
            ...
            ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><?= $result['nama_kopi']; ?> - <?= $result_kat['kategori']?></h5>
                               <p class="card-text">
                               <?= $result['keterangan'] ?>
